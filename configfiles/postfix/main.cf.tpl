...
myhostname = mailhub.${domain_name}
...
#mydestination = $myhostname, localhost.$mydomain, localhost, $mydomain, test.mulini.org, mulini.org
...
virtual_mailbox_domains = $mydomain,${domain_name}
...
#
# SASL for SMTP client auth:
smtpd_sasl_type = dovecot
smtpd_sasl_path = private/auth
smtpd_sasl_auth_enable = yes
#
# Configure all the TLS stuff:
smtpd_use_tls=yes
smtpd_tls_auth_only = yes
smtpd_tls_cert_file = /etc/letsencrypt/live/mailhub/fullchain.pem
smtpd_tls_key_file = /etc/letsencrypt/live/mailhub/privkey.pem
#Disable Poodle
